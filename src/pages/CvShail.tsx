        ...
        <div className={styles.myContainer}>
          <div className="flex items-center justify-start space-x-12 mb-20">
            ...
            <div className="mx-6 space-y-1">
              ...
              <p>
                <span className="font-bold">Phone number:</span> +9779802235854
              </p>
              <p>
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-800">
              ...
              career in Information Technology, constantly striving for
          ...
          <div className="mb-20">
            ...
            <div className="space-y-2 mb-8">
              <h3 className="font-bold text-2xl text-sky-900">IT Manager</h3>
              <p className="text-gray-800">
            ...
            <div className="space-y-2 mb-8">
              <h3 className="font-bold text-2xl text-sky-900">IT Officer</h3>
              <p className="text-gray-800">
                <span className="font-bold text-gray-600">
              ...
              <p className="text-gray-800">
                System Administration, IT Support, Leadership, Training,
                Software Maintenance, MIS, Networking, Budgeting
              </p>
              <hr className="mt-6 border-t border-gray-300"/> 
            </div>
          ...
          <div className="mb-20">
            ...
            <div className="border-b border-gray-500 my-4 border-2 opacity-50"></div>
            <div className="space-y-2 mb-8">
              <h3 className="font-bold text-2xl text-sky-900">CCNA</h3>
              <p className="text-gray-800">
                <span className="font-bold text-gray-600">KVCH </span>
                [12/06/2017- 27/07/2017]
              </p>
              <p className="text-gray-800">
                City: India | Country: India | Website:{" "}
            ...
            <div className="space-y-2 mb-8">
              ...
              <p className="text-gray-800">
                City: Kathmandu | Country: Nepal | Website:{" "}
            ...
            <div className="space-y-2 mb-8">
              <h3 className="font-bold text-2xl text-sky-900">PHP & MYSQL</h3>
              <p className="text-gray-800">
                <span className="font-bold text-gray-600">
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-800">
              on securing second position in Masters of Computer Application
              (MCA)
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-800 mb-4">
              MongoDB, MySQL, Docker, AWS, GitHub/GitLab/Bitbucket, CI/CD
            ...
            <p className="text-gray-800 mb-4">
              Figma, Canva, Adobe Photoshop, Microsoft Office (Excel,
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-800">
              <span className="font-bold text-gray-600">Learning:</span> French
            </p>
          </div>
